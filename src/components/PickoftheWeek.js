    ...
    <section id="about" className="my-3">
      <div className="text-center my-2 py-3">
        <h2 className="display-5 text-success">
          <i class="bi bi-stars"></i>Pick of the Week!
          ...
          <Col md={5}>
            <div className="p-3">
              ...
              <p className="lead text-muted">
                ...
                dolorem voluptatem. Optio quam nisi ipsam voluptatibus tenetur
                delectus voluptatem adipisci quod perspiciatis? Tempora
                reprehenderit praesentium, iste molestias minus blanditiis
                explicabo.
              </p>
